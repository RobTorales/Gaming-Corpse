    ...
    <div className="container">
      <nav id="navbar-example2" className="navbar bg-body-tertiary px-3 mb-3">
          ...
          <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" className="scrollspy-example bg-body-tertiary p-3 rounded-2" tabindex="0">
            ...
            <h4 id="scrollspyHeading2" className="text-primary">Tiempo de garantía</h4>
            <p>El tiempo de garantía del producto se encuentra indicado en la factura de compra. De realizar una compra con varios ítems, el tiempo de garantía de cada producto estará detallado en la factura. Es requisito conservar la caja, empaque, manuales, etiquetas y accesorios para realizar el trámite de garantía. Si el fabricante del producto ofrece un tiempo mayor de garantía, pasado el tiempo de garantía que ofrece Newton Station S.R.L el cliente debe contactarse directamente con la marca, no teniendo Newton Station S.R.L responsabilidad alguna sobre esa gestión y su resolución.</p>
            <h4 id="scrollspyHeading3" className="text-primary">Cobertura de garantía</h4>
            <p>Se cubrirán los desperfectos del uso normal de los productos; para ello, el equipo técnico de Posventa realizará la revisión correspondiente, y así se cerciorará de que el daño/defecto no se ocasionó por uso inadecuado del cliente. Esto será dentro del plazo de garantía que ofrece Newton Station S.R.L, siempre y cuando se hayan respetado todas las especificaciones de trabajo y rangos establecidos de operación que constan en los manuales que acompañan a cada unidad. Todo lo que se encuentre fuera de esta condición, será motivo suficiente de exclusión de la garantía. Cualquier intervención ajena, que a juicio exclusivo del personal técnico de Newton Station S.R.L haya perjudicado o pueda perjudicar el buen funcionamiento de un producto, como ser virus, golpe, maltrato, rayones, falta de etiqueta de serialización, negligencia (la lista no es limitante) será razón suficiente para la exclusión de la garantía. En ningún caso Newton Station S.R.L está obligado a reemplazar un producto sin que este sea revisado por sus técnicos y estos determinen si cumple con las condiciones de garantía y se verifique la falla de este.</p>
            <h4 id="scrollspyHeading4" className="text-primary">Devolucion</h4>
            <p>Dentro de los 30 días corridos de recibida la compra el cliente puede pedir la devolución para recibir la Nota de Crédito, el producto debe estar en las mismas condiciones en las que fue recibido (con todos los componentes y packaging) sin uso, debe disponer el producto para su recolección por parte de Newton Station S.R.L. La verificación del estado del producto será realizada por el personal técnico de Newton Station S.R.L, quienes se pondrán en contacto con el cliente para informarle el resultado de la inspección, si el producto califica para la Nota de Crédito o no y los pasos a seguir. En caso de que el producto no califique para generar la Nota de Crédito se coordinara la devolución por correo o el retiro por las instalaciones de Newton Station S.R.L según preferencia del cliente. Dejamos expresa constancia que en caso de devoluciones del producto adquirido dentro de los 30 días de la compra, la Empresa contra entrega del producto hará una nota de crédito por idéntico valor al abonado por el Cliente ello sin perjuicio que el precio del producto pudiera haber sufrido variaciones en su precio (ya sea reducciones como aumentos, de considerable cuantía o no) de conformidad a lo previsto por el art 3 de la Ley 3.281 CABA.</p>
            <h4 id="scrollspyHeading5" className="text-primary">Salvaguarda de información</h4>
            <p>La salvaguarda de la información (archivos personales o programas) será responsabilidad del cliente. Newton Station S.R.L no se responsabiliza por la pérdida de información ni el lucro cesante producto de la falla de el o los productos</p>
            <h4 id="scrollspyHeading6" className="text-primary">Garantía solicitada por terceros</h4>
            <p>Para que la garantía sea utilizada por un tercero, este debe presentar una nota del titular de la compra autorizándolo a realizar el trámite de garantía, tanto sea para hacer el ingreso como el retiro de un producto. La nota debe detallar:
              <ul>
                <li>Nombre, Apellido y DNI del titular de la compra</li>
                <li>Nombre, Apellido y DNI de la persona que se autoriza a tramitar la garantía</li>
                <li>Copia del DNI del titular de la compra</li>
              </ul>
            </p>
            <h4 id="scrollspyHeading7" className="text-primary">Reparación o reemplazo de productos</h4>
            <p>La reparación o el reemplazo del producto, podrá efectuarse con productos nuevos o reacondicionados cuyo funcionamiento sea equivalente al de los originales, garantizando un correcto funcionamiento según criterio exclusivo de Newton Station S.R.L</p>
            <h4 id="scrollspyHeading8" className="text-primary">Envío/retiro del service</h4>
            ...
            <p>En caso de que el personal técnico de Newton Station S.R.L. declare un producto como fuera de garantía se le informara al cliente para coordinar la devolución del producto, quedando Newton Station S.R.L. sin responsabilidad sobre el funcionamiento y fallas que presente el producto. En caso de considerar posible y bajo exclusivo criterio de Newton Station S.R.L. se puede ofrecer el intento de reparación sobre un producto con daño físico y/o que este fuera de garantía (esto aplica a daño físico y garantía vencida por tiempo). Esto no constituye la aceptación del producto en garantía ni es garantía de que el arreglo del producto sea exitoso. El cliente acepta que no podrá reclamar garantía sobre el arreglo ni el funcionamiento del producto. Serán causas de anulación de la garantía (la lista no es limitante):
              <ul>
                ...
                <li>Daños físicos tales como signos de maltrato o mala manipulación</li>
                <li>Daños por líquidos y/o rastros de humedad</li>
                <li>Excesos o caídas de tensión eléctrica</li>
                <li>Instalación en condiciones distintas a las recomendadas en el Manual del Usuario</li>
